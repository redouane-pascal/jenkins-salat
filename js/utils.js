...
function addTenMinute(t) {
    return moment(t, "HH:mm").add(10, "m").format("HH:mm");
}
        ...
        if (typeof(Storage) !== "undefined") {
            ...
            if (currentDate === dayNotif) {
                ...
                fetch("data.json")
                    ...
                    .then(data => {
                        let byCityAndMonthAndDay = d => d.id == cityId && d.day == moment().format("YYYY-MM-DD");
                        let filtredData = data.filter(byCityAndMonthAndDay);
                        prayerTimes = filtredData[0];
...
function setBadgeText(sobh, dohr, asr, maghreb, isha) {
    ...
    badgeText = badgeText != "..." ? minutesToHourFormat(diffNowToNextPrayer) : "";
...
function showBars() {
    ...
    if (isha) {
        ...
        document.getElementById("salatTime1") != null ? document.getElementById("salatTime1").textContent = sobh : "";
        document.getElementById("salatTime2") != null ? document.getElementById("salatTime2").textContent = dohr : "";
        document.getElementById("salatTime3") != null ? document.getElementById("salatTime3").textContent = asr : "";
        document.getElementById("salatTime4") != null ? document.getElementById("salatTime4").textContent = maghreb : "";
        document.getElementById("salatTime5") != null ? document.getElementById("salatTime5").textContent = isha : "";
...
function showTodayBar() {
    ...
    document.getElementById("currentHour") != null ? document.getElementById("currentHour").textContent = currentHour : "";
}